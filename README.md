...
هذا القسم مخصص لتعديل ملفات AVL.

وظيفة ملف AVL:
- التحكم بإغلاق أو فتح AEV باستخدام المفاتيح داخل اللعبة

يمكنك تعديل الملف من خلال واجهة سهلة بدون الحاجة إلى HxD.
...
- واجهة سهلة وبسيطة
- تقليل الحاجة لاستخدام HxD
- دعم اللغة العربية والإنجليزية
- جميع الأدوات داخل برنامج واحد
- دعم التعديل المباشر على ملفات اللعبة
- نظام مرتب وسهل الاستخدام
- تعمل بدون الحاجة لتثبيت المكتبات يدوياً
- متوافقة مع Winlator
